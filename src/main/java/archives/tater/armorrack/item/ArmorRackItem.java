...
public class ArmorRackItem extends ArmorStandItem implements ArmorStandProvider {
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        return resultStack == null
                ...
                : resultStack == itemStack
                        ...
                        : ActionResult.SUCCESS.withNewHandStack(resultStack);
    }
    ...
    private static @Nullable ItemStack trySwap(PlayerEntity user, ItemStack stack) {
        ...
        if (empty && Arrays.stream(EquipmentSlot.values()).allMatch(slot -> !slot.isArmorSlot() || user.getEquippedStack(slot).isEmpty()))
            return null;
        ...
        for (ArmorStandArmorComponent.Slot slot : ArmorStandArmorComponent.Slot.values()) {
            ...
            if (EnchantmentHelper.hasAnyEnchantmentsWith(equippedArmor, EnchantmentEffectComponentTypes.PREVENT_ARMOR_CHANGE))
                continue;
        ...
        user.giveOrDropStack(resultStack);
        return stack;
    }
